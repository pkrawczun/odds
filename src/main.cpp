...
int main (int argc, char** argv) {
  ...
  //the_connection = GenerateLinearTable("premier_league", "2024-09-16", "2025-09-15",
  //                                     2.22f, 1.78f, 2.22f, 3.33f, std::move(the_connection));
  /*the_connection = GenerateLinearTable("bundesliga", "2024-09-16", "2025-09-15",
                                       2.22f, 1.78f, 2.22f, 3.33f, std::move(the_connection));
  the_connection = GenerateLinearTable("ligue_1", "2024-09-16", "2025-09-15",
                                       2.22f, 1.78f, 2.22f, 3.33f, std::move(the_connection));
  the_connection = GenerateLinearTable("serie_a", "2024-09-16", "2025-09-15",
                                       2.22f, 1.78f, 2.22f, 3.33f, std::move(the_connection));
  the_connection = GenerateLinearTable("primera_division", "2024-09-16", "2025-09-15",
                                       2.22f, 1.78f, 2.22f, 3.33f, std::move(the_connection));
  */
  //SimpleSemiConventionalAnnualAlgorithm("premier_league", "2009-08-01", "2025-09-09");
  //SimpleLinearAnnualAlgorithm("bundesliga", "1963-08-01", "2025-09-25", 2.22f, 1.78f, 2.22f, 3.33f);
